...
5. [Two-dimensional wave-packet propagation](05_two_dimensional_wave_packet/README.md)
...
- Two-dimensional FFTs, area normalization, and spatial covariance
- Exact normal-mode motion for a coupled quadratic potential

Chapters 1–3 use finite boxes with zero Dirichlet boundaries, which reflect
packets. Chapters 4 and 5 use periodic FFT boundaries, where packets wrap around
