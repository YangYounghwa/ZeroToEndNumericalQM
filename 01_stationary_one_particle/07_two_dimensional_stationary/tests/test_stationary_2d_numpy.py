...
def test_grid_shapes_and_flattening_convention() -> None:
    result = solution.solve_stationary_2d(num_x=12, num_y=10, num_states=3)
...
def test_wavefunctions_are_orthonormal_and_residuals_are_small() -> None:
    result = solution.solve_stationary_2d(num_x=18, num_y=16, num_states=5)
...
def test_symmetric_potential_has_zero_position_expectations() -> None:
    result = solution.solve_stationary_2d(num_x=20, num_y=18, num_states=5)
