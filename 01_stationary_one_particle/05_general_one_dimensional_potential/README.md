...
4. `boilerplates/general_potential_numpy_starter.py`
5. `boilerplates/general_potential_torch_starter.py`
6. `boilerplates/general_potential_convergence_starter.py`
7. `solutions/general_potential_numpy_solution.py`
8. `solutions/general_potential_torch_solution.py`
