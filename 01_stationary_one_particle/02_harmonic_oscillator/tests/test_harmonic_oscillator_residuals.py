...
import harmonic_oscillator_numpy_solution as reference
import harmonic_oscillator_torch_solution as solution
import numpy as np
import torch


def test_residual_detects_wrong_energy_despite_normalized_state() -> None:
    result = solution.solve_harmonic_oscillator(num_points=70, num_states=3)
    ...
    numpy_result = reference.solve_harmonic_oscillator(num_points=70, num_states=3)
